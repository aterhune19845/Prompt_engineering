...
* claude_summary_agent should validate or force Claude returned valid JSON with the required fields, doing a json.loads on the response if its not valid json will crash.
